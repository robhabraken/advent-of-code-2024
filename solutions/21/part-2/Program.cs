...
var lines = File.ReadAllLines("..\\..\\..\\..\\..\\..\\..\\advent-of-code-2024-io\\21\\input.example");
...
for (var i = 0; i < nboRobots; i++)
    robots.Add(new DirectionalKeypad($"Robot 0{i.ToString().PadLeft(2, '0')}"));
...
//Console.WriteLine(169035252876234); // this was too low
...
long typeCode(string code)
{
    ...
    foreach (var character in code)
    {
        ...
        Console.WriteLine(character + " of " + code + " finished (" + s.ElapsedMilliseconds + ")");
    }
...
void pressButtons(char button, int robotIndex, ref long length)
{
    ...
    Console.WriteLine($"{"".PadLeft(robotIndex, ' ')}{button} -> {sequence}");
...
class DirectionalKeypad : Keypad
{
    ...
    public DirectionalKeypad(string name)
    {
        x = 2;
        y = 0;
        ...
        this.name = name;
        sequences = new Dictionary<char, string>();
    }
